...
'Hello World from Web2py Controller': 'Hello World from Web2py Controller',
'help': 'ayuda',
...
'Registration is pending approval': 'Registracion esta pendiente de aprobacion',
