...
response.meta.description = 'tapa 14'
...
#response.menu = [
#    (T('Venta'), False, URL('default', 'venta'), []),
#    (T('Reserva'), False, URL('default', 'reserva'), []),
#    (T('Ingreso'), False, URL('default', 'ingreso'), [])
#    ]
#response.menu = [(T('calculadora'), False, URL('default', 'index'), []),]
response.menu = []
